...
class CountryResourceIT {
    ...
    private static final String DEFAULT_COUNTRY_AREA_CODE = "AAAAAAAAAA";
    private static final String UPDATED_COUNTRY_AREA_CODE = "BBBBBBBBBB";
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country().countryName(DEFAULT_COUNTRY_NAME).countryAreaCode(DEFAULT_COUNTRY_AREA_CODE);
        return country;
    }
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country country = new Country().countryName(UPDATED_COUNTRY_NAME).countryAreaCode(UPDATED_COUNTRY_AREA_CODE);
        return country;
    }
    ...
    void createCountry() throws Exception {
        ...
        assertThat(testCountry.getCountryAreaCode()).isEqualTo(DEFAULT_COUNTRY_AREA_CODE);
    }
    ...
    void getAllCountries() throws Exception {
        ...
        restCountryMockMvc
            ...
            .andExpect(jsonPath("$.[*].countryAreaCode").value(hasItem(DEFAULT_COUNTRY_AREA_CODE)));
    }
    ...
    void getCountry() throws Exception {
        ...
        restCountryMockMvc
            ...
            .andExpect(jsonPath("$.countryAreaCode").value(DEFAULT_COUNTRY_AREA_CODE));
    }
    ...
    void putExistingCountry() throws Exception {
        ...
        updatedCountry.countryName(UPDATED_COUNTRY_NAME).countryAreaCode(UPDATED_COUNTRY_AREA_CODE);
        ...
        assertThat(testCountry.getCountryAreaCode()).isEqualTo(UPDATED_COUNTRY_AREA_CODE);
    }
    ...
    void fullUpdateCountryWithPatch() throws Exception {
        ...
        partialUpdatedCountry.countryName(UPDATED_COUNTRY_NAME).countryAreaCode(UPDATED_COUNTRY_AREA_CODE);
